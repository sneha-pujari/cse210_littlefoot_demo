import {
  ...
  export const DEFAULT_SETTINGS: Settings = {
    ...
    numberResetSelector: '',
    scope: '',
    contentTemplate: `<aside class="littlefoot__popover" id="fncontent:<% id %>"><div class="${CLASS_WRAPPER}"><div class="${CLASS_CONTENT}"><% number %>.<% content %></div></div><div class="${CLASS_TOOLTIP}"></div></aside>`,
